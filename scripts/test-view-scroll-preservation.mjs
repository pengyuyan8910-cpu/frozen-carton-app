...
assert.match(bootstrap, /const APP_VERSION\s*=\s*"20260902_product_dimensions_v3"/, '页面脚本更新必须使用新的 app.js 缓存版本');
assert.match(index, /bootstrap\.js\?v=20260902_product_dimensions_v3/, '页面脚本更新必须使用新的 bootstrap.js 缓存版本');
