...
function 陈列图下架SKU(id){
  ...
  if(!当前是否运营()){alert("纳入SKU需要先进入运营模式。");return}
  ...
  保存();渲染全部();
  完成提示("SKU已纳入当前门店，并进入待选区。请手动拖到可用柜段后再同步店员端。");
}
